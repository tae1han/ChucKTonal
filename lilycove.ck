...
string measures_p[7][0];
string measures_r[7][0];

for(int i; i < 7; i++)
{
    [tuba_pitch[i], cello_pitch[i], viola_pitch[i], violinII_pitch[i], violinI_pitch[i], flute_pitch[i]] @=> measures_p[i];
    [tuba_rhythm[i], cello_rhythm[i], viola_rhythm[i], violinII_rhythm[i], violinI_rhythm[i], flute_rhythm[i]] @=> measures_r[i];
}
